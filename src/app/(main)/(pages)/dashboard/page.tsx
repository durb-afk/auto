...
const DashboardPage = () => {
  ...
  return (
    <div className={`flex  h-screen pr-40 `}>
            <Sidebar />
            <div className={`w-full 'flex-1' sticky`}>
                <InfoBar />
                <div className="flex flex-1 items-center justify-center">
      <div className="flex flex-col gap-4">
      <h1 className="text-4xl sticky top-0 z-[10] p-6 bg-background/50 backdrop-blur-lg block items-center border-b">
        Dashboard
      </h1>
      <div className="flex flex-col gap-4 relative">
        <div className="flex w-screen pl-20 gap-10 overflow-x-scroll">
